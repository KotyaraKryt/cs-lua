            ...
            'items': [
                ...
                },
                {
                    ...
                    'fields': ('Опции', [
                        ...
                        ('channel', 'number', '`0..3`, разные каналы не затирают друг друга. По умолчанию `-1` — берётся свободный автоматически (для каждого игрока отдельно, наименее давно использованный), как `channel = -1` в set_hudmessage AmxModX'),
                    ]),
                    'example': """
