...
""",
                ...
                {
                    'name': 'e:detonate_on_touch',
                    'brief': 'Следующее касание сразу запускает think сущности.',
                    'sig': 'e:detonate_on_touch()',
                    'args': [],
                    'extra': """
...
[`e:detonate_on_touch`](detonate_on_touch.md) не исключение, а частный случай:
